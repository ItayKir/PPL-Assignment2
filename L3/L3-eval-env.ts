...
const applyObject = (obj: Object, args: Value[]): Result<Value> => {
    ...
    // Evaluate the method within the object's extended environment state, 
    // resolving it into a Closure, then apply it to the remaining arguments
    return bind(applicativeEval(methodBinding.val, obj.env), (methodClosure: Value) =>
